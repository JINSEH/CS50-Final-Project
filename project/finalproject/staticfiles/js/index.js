...
const data = {
  ...
  {
    type: 'bar',  // Add second bar dataset
    label: 'Inventory',
    data: [15000, 13500, 17000, 20000, 21000, 23000, 20000, 17000, 13000, 20000, 25000, 23000],  // New data for the second bar dataset
    yAxisID: 'y',  // Same y-axis ID if you want them on the same scale
  },
  {
      type: 'line',
...
new Chart(document.getElementById('mixed-chart'), config);  // Use the config when creating the chart
